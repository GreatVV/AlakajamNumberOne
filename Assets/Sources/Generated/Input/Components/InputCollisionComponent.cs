...
public partial class InputEntity {
    ...
    public void AddCollision(GameEntity newObject1, GameEntity newObject2) {
        var index = InputComponentsLookup.Collision;
        var component = CreateComponent<CollisionComponent>(index);
        component.Object1 = newObject1;
        component.Object2 = newObject2;
        AddComponent(index, component);
    }

    public void ReplaceCollision(GameEntity newObject1, GameEntity newObject2) {
        var index = InputComponentsLookup.Collision;
        var component = CreateComponent<CollisionComponent>(index);
        component.Object1 = newObject1;
        component.Object2 = newObject2;
