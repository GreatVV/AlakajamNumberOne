...
public partial class GameContext {
    ...
    public GameEntity SetGameField(int newWidth, int newHeight) {
        if (hasGameField) {
        ...
        entity.AddGameField(newWidth, newHeight);
        return entity;
    }

    public void ReplaceGameField(int newWidth, int newHeight) {
        var entity = gameFieldEntity;
        if (entity == null) {
            entity = SetGameField(newWidth, newHeight);
        } else {
            entity.ReplaceGameField(newWidth, newHeight);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddGameField(int newWidth, int newHeight) {
